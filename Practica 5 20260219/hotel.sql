...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 19-02-2026 a las 15:51:16
...
(1, 9, 4, '2026-01-01', 'Pésimo Servicio.\r\nEmpleado detestable y poco cordial.'),
(2, 6, 2, '2026-02-05', 'No cuenta con suficiente capacitación. No trajo destornillador para arreglar la chapa.'),
(3, 8, 5, '2026-01-29', 'Muy amable.'),
(4, 9, 1, '2025-11-25', 'Servicio muy agradable.'),
(5, 1, 3, '2025-08-11', 'Pesimo servicio');
...
(1, 10, '2026-02-20', '15600', 'Tarjeta', '4027493281903984', 'Pendiente'),
(2, 3, '2026-02-18', '1800', 'Efectivo', '4027493281903985', 'Pagado'),
(3, 4, '2025-12-30', '2650', 'Tarjeta', '4027493281903986', 'Pendiente'),
(4, 5, '2026-02-05', '9999', 'Tarjeta', '4027493281903987', 'Pagado'),
(5, 1, '2026-02-05', '9999999999999999', 'Efectivo', '4027493281903988', 'Pagado');
...
(1, 'Spa', 1500),
(2, 'Valet Parking', 50),
(3, 'Servicio a la habitación', 50),
(4, 'Toallas extra', 40),
(5, 'Acceso a gimnasio', 800);
